...
//   return (
//     <Table striped bordered hover variant='dark' style={{width: "100%", height: "50px"}}>
//     <thead>
//         <tr >
//         <th style={{textAlign: "center"}}>Repositry</th>
...
//            <td style={{textAlign: "center"}}>{repo.language}</td>
//            <td style={{textAlign: "center"}}>{repo.url}</td>
//        </tr>
//        })}
//     </tbody>
